...
module.exports = {
  ...
  ANALYTICS_BUSUANZI_ENABLE:
    process.env.NEXT_PUBLIC_ANALYTICS_BUSUANZI_ENABLE || false, // 展示网站阅读量、访问数 see http://busuanzi.ibruce.info/ （默认关闭，改用 Umami）
  ...
  UMAMI_SHARE_TOKEN: process.env.NEXT_PUBLIC_UMAMI_SHARE_TOKEN || '',
