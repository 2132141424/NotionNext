    ...
    return (
      <Html lang={BLOG.LANG}>
        <Head>
          ...
          {/* 预加载遮罩：样式 + 脚本在 Head 中，div 在 body 中 */}
          <style dangerouslySetInnerHTML={{ __html: `
            #preload-cover{position:fixed;top:0;left:0;width:100%;height:100%;z-index:99999;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#f7f9fe}
            .dark #preload-cover{background:#18171d!important}
            #preload-progress{height:100%;width:0;background:#4f65f0;border-radius:2px;transition:width 0.4s ease}
